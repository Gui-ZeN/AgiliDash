...
const AlertBanner = ({
  ...
  const configs = {
    ...
    error: {
      ...
      buttonBg:
        'bg-red-100 dark:bg-red-900/40 hover:bg-red-200 dark:hover:bg-red-800/60 text-red-800 dark:text-red-300',
    },
    success: {
      icon: CheckCircle,
      ...
      buttonBg:
        'bg-emerald-100 dark:bg-emerald-900/40 hover:bg-emerald-200 dark:hover:bg-emerald-800/60 text-emerald-800 dark:text-emerald-300',
    },
    info: {
      icon: Info,
      ...
      buttonBg:
        'bg-blue-100 dark:bg-blue-900/40 hover:bg-blue-200 dark:hover:bg-blue-800/60 text-blue-800 dark:text-blue-300',
    },
  };
