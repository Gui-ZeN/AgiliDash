...
const CnpjFilter = ({ className = '' }) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-72 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-md z-50 overflow-hidden max-h-[400px] overflow-y-auto">
          {/* Consolidado */}
