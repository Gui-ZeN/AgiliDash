...
const CnpjFilter = ({ className = '' }) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      >
        <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-[#0e4f6d] to-[#58a3a4] flex items-center justify-center">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-72 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl z-50 overflow-hidden max-h-[400px] overflow-y-auto">
          ...
          <div className="p-2 border-b border-slate-100 dark:border-slate-700">
            <p className="px-2 py-1 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Consolidado</p>
            ...
            {listaCnpjs.map((cnpj) => (
              ...
              >
                ...
                <div className="flex-1 text-left min-w-0">
                  ...
                  <p className="text-[10px] text-slate-400">{cnpj.cnpj}</p>
                </div>
